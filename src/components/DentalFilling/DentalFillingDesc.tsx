...
const DentalFillingDesc:React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-16 lg:gap-20">
        ...
        <div className="relative flex-shrink-0 w-full md:w-[45%] lg:w-[40%] aspect-[4/5] animate-in slide-in-from-left duration-700">
          ...
          <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl">
            <img 
              src="src/assets/images/dental-fill-desc.png" 
        ...
        <div className="flex-1 w-full max-w-2xl space-y-14">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#64748B] text-lg md:text-xl leading-relaxed font-Manrope font-light">
             Dental fillings are a simple and effective way to repair teeth affected by cavities or minor damage. At Orchid Dental Care, we use high-quality, tooth-colored materials to restore the natural strength,
              function, and appearance of your teeth—helping you maintain a healthy, confident smile.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#64748B] text-lg md:text-xl leading-relaxed font-Manrope font-light">
              When a cavity is left untreated, it can grow deeper and lead to pain, infection, or even tooth loss. Dental fillings stop decay in its tracks by removing the damaged portion and sealing the tooth.
               This not only prevents further damage but also restores normal chewing and protects your overall oral health.
            </p>
          </div>
...
export default DentalFillingDesc
