...
const DentalCrownHome = () => {
  return (
      ...
      <div className="flex-1 py-16 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
        <div className="max-w-xl space-y-6">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-[#1D2B53] leading-[1.1]">
            Dental 
            <span className="text-[#A35DA3]"> Crowns</span>
          </h1>
      ...
      <div className="flex-1 relative min-h-[500px] md:min-h-0">
        <img 
          src="https://travel-pdfs-prod-399934155938-eu-north-1-an.s3.eu-north-1.amazonaws.com/pdf/dental-crown-main.jpg" 
...
export default DentalCrownHome
