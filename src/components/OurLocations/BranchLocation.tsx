    ...
    <div className="flex flex-col md:flex-row items-start justify-between bg-white p-8 rounded-3xl gap-8 max-w-6xl mx-auto">
      ...
      <div className="flex gap-4 max-w-sm w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {/* BUTTON CONTAINER: flex-col on mobile, flex-row on md+ */}
          <div className="mt-6 flex flex-col md:flex-row items-center gap-3 w-full">
            <button className="flex items-center justify-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full font-bold text-sm hover:shadow-lg transition-all active:scale-95 shadow-[#25D366]/20 shadow-md h-[48px] whitespace-nowrap w-full md:w-auto">
              <MessageCircle size={18} fill="currentColor" /> WhatsApp Us
            </button>
            
            <button className="flex items-center justify-center gap-2 bg-[#442344] text-white px-6 py-3 rounded-full font-bold text-sm hover:bg-[#331a33] transition-all active:scale-95 shadow-md h-[48px] whitespace-nowrap w-full md:w-auto">
              <Navigation size={18} /> Get Directions
            </button>
          </div>
        </div>
