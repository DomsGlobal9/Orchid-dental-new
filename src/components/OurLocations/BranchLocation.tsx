...
//             <button className="flex items-center gap-2 mt-5 bg-[#25D366] text-white px-6 py-3 rounded-full font-bold text-sm hover:shadow-lg transition-all active:scale-95 shadow-[#25D366]/20 shadow-md">
//               <MessageCircle size={18} fill="currentColor" /> WhatsApp Us
//             </button>
//             <button className="flex items-center gap-2 mt-5 w-xs bg-[#442344] text-white px-6 py-3 rounded-full font-bold text-sm hover:bg-[#331a33] transition-all active:scale-95 shadow-md">
