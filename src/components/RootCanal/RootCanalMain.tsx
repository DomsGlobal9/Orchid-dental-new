      ...
      <div className="flex-1 py-16 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
        <div className="max-w-xl space-y-6">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-[#1D2B53] leading-[1.1]">
            Root Canal <br/>
            <span className="text-[#A35DA3]"> Treatment</span>
          </h1>

          {/* Description */}
          <p className="text-gray-500 text-lg font-light leading-relaxed">
            Advanced root canal care that relieves pain, saves your
             natural tooth, and preserves your healthy, confident smile for years to come.
          </p>
