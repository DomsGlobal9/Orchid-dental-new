...
const CosmeticHome = () => {
  return (
    <div className="relative min-h-[600px] w-full mt-3 overflow-hidden bg-[#442140] font-sans text-white">
      {/* Background Layer */}
      <div className="absolute inset-0 z-0">
        <img 
          src="https://travel-pdfs-prod-399934155938-eu-north-1-an.s3.eu-north-1.amazonaws.com/pdf/aligners-main.jpg" 
          ...
          <div className="space-y-8 pl-0"> 
            <div className="space-y-4">
              <h1 className="font-serif text-5xl font-light tracking-wide uppercase md:text-7xl lg:leading-tight">
                Smiles come easily with <br /> 
                <span className="block font-bold">our aligners</span>
              </h1>
