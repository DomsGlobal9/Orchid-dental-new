...
const PinkKerla = () => {
  return (
    <div className="bg-[#FDD8F8] py-16 px-6 md:px-12 lg:px-24 font-sans text-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        
        {/* Left Text Content Section */}
        <div className="flex-1 space-y-8">
          <h2 className="text-4xl text-[#000000] md:text-5xl lg:text-6xl font-light leading-tight">
            kerala's <span className="text-[#000000] font-xl font-serif italic">1<sup className="text-[0.8em] text-[#000000] ml-0.5">st</sup></span> Landmark for <br />
            Invisalign Excellence
          </h2>
          <p className="text-[#000000] text-lg md:text-xl leading-relaxed max-w-xl">
