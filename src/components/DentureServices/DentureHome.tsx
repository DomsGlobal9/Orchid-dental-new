  ...
  return (
   <section className="w-full bg-white flex flex-col md:flex-row items-stretch font-sans">
      ...
      <div className="flex-1 py-16 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
        <div className="max-w-xl space-y-6">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-[#1D2B53] leading-[1.1]">
            Denture 
            <span className="text-[#A35DA3]"> Services</span>
          </h1>

          {/* Description */}
          <p className="text-gray-500 text-lg font-light leading-relaxed">
            Comprehensive denture solutions that restore your smile, 
            improve function, and help you enjoy a confident, comfortable life for years to come.
          </p>
      ...
      <div className="flex-1 relative min-h-[500px] md:min-h-0">
        <img 
          src="https://travel-pdfs-prod-399934155938-eu-north-1-an.s3.eu-north-1.amazonaws.com/pdf/rootcanal-main.png" 
