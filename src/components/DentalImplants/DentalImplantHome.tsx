...
const DentalImplantHome = () => {
  return (
    <div className="relative min-h-[600px] mbe-3.5 w-full mt-3 overflow-hidden bg-[#442140] font-sans text-white">
      {/* Background Layer */}
      <div className="absolute inset-0 z-0">
        <img 
          src="src/assets/images/aligners-main.jpg" 
          ...
          <div className="space-y-8 pl-0"> 
            <div className="space-y-4">
              <h1 className="font-serif text-5xl font-light tracking-wide uppercase md:text-7xl lg:leading-tight">
                Rebuild your smile with <br /> 
                <span className="block font-bold">our dental implants.</span>
              </h1>
              <p className="max-w-md text-lg font-light leading-relaxed text-gray-200">
                   Permanent, confident smiles begin with our advanced dental implants.
              </p>
            </div>
...
export default DentalImplantHome
