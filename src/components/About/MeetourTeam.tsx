...
const MeetourTeam: React.FC = () => {
  const team = [
    {
      name: "Doctor 1",
      image: "src/assets/images/meetourteam1.png"
    },
    {
      name: "Doctor 2",
      image: "src/assets/images/meetourteam2.png"
    },
    {
      name: "Doctor 3",
      image: "src/assets/images/meetourteam3.png"
    },
    {
      name: "Doctor 4",
      image: "src/assets/images/meetourteam4.png"
    }
  ];
  ...
  return (
    <div className="bg-[#F3E8F3] py-20 px-6 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        {/* Header Section */}
        <div className="mb-12">
          <p className="text-[#5D3E5D] font-medium text-sm mb-4">
