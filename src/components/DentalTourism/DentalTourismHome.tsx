          ...
          <div className="space-y-8 pl-0"> 
            <div className="space-y-4">
              <h1 className="font-serif text-5xl font-light tracking-wide uppercase md:text-7xl lg:leading-tight">
                Smile brighter while you travel with <br /> 
                <span className="block font-bold">our dental tourism.</span>
              </h1>
...
export default DentalTourismHome
