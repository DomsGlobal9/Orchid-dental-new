...
const CompositeHome = () => {
    return (
    <div className="relative min-h-[600px] w-full mt-3 mb-3 overflow-hidden bg-[#442140] font-sans text-white">
      {/* Background Layer */}
          ...
          <div className="space-y-8 pl-0"> 
            <div className="space-y-4">
              <h1 className="font-serif text-5xl font-light tracking-wide uppercase md:text-7xl lg:leading-tight">
                Perfect your smile with  <br /> 
                <span className="block font-bold">our composite bonding.</span>
              </h1>
